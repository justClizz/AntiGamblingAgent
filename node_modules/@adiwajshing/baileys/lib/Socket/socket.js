...
const makeSocket = ({ waWebSocketUrl, connectTimeoutMs, logger, agent, keepAliveIntervalMs, version, browser, auth: initialAuthState, printQRInTerminal, defaultQueryTimeoutMs }) => {
    ...
    const keys = (0, Utils_1.addTransactionCapability)(authState.keys, logger);
    let lastDateRecv;
    let epoch = 0;
    let keepAliveReq;
    let qrTimer;
    ...
    const assertingPreKeys = async (range, execute) => {
        ...
        await keys.transaction(async () => {
            ...
            const preKeys = await (0, Utils_1.getPreKeys)(keys, preKeysRange[0], preKeysRange[0] + preKeysRange[1]);
