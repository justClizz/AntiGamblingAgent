...
const makeMessagesRecvSocket = (config) => {
    ...
    const processMessageLocal = async (msg) => {
        ...
        const newEvents = await (0, process_message_1.default)(msg, { historyCache, meId, accountSettings: authState.creds.accountSettings, keyStore: authState.keys, logger, treatCiphertextMessagesAsReal });
    ...
    ws.on('CB:message', (stanza) => {
        ...
        processingMutex.mutex(msg.key.remoteJid, async () => {
            ...
            msg.key.remoteJid = (0, WABinary_1.jidNormalizedUser)(msg.key.remoteJid);
